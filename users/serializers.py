...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['id', 'username',"first_name","last_name", 'email', 'phone', 'password',"picture_file","picture", "storage_key", "favourite_listings","saved_search","province","city","streetname_number","province_detail","city_detail"]
        read_only_fields = ["picture", "storage_key", "favourite_listings","saved_search","province_detail","city_detail"]        
