...
from .views import UserDetailView, UserCreateView, UserListView,UserMeView, AddSavedSearch, SavedSearchDetailUpdateDelete, SendEmailVerficationCode,VerifyUser, SendPasswordRecoveryEmail, RecoverPassword, ChangePassword
