        ...
        return Response(
            {
                ...
                "ai-comparator":reverse("ai-compare", request=request),
                ...
                "cars": {
                    ...
                    "control_brands": reverse("carbrand-control-list", request=request),
                    "control_models": reverse("carmodel-control-list", request=request),
                    "control_trims": reverse("carmodeltrim-control-list", request=request),
